...
model = tf.keras.models.Sequential([
  ...
  tf.keras.layers.Conv2D(256, (2, 2), strides=(1,1), activation='relu', name='L2_conv2d', dtype="mixed_float16"),
  tf.keras.layers.MaxPooling2D(pool_size=(2, 2), strides=2, name='L3_MaxP', dtype="mixed_float16"),
  tf.keras.layers.Conv2D(256, (1, 1), activation='relu', name='L4_conv2d', dtype="mixed_float16"),
  tf.keras.layers.Conv2D(512, (2, 2), activation='relu', name='L5_conv2d', dtype="mixed_float16"),
  tf.keras.layers.MaxPooling2D(pool_size=(2, 2), strides=2, name='L6_MaxP', dtype="mixed_float16"),
  tf.keras.layers.Conv2D(256, (1, 1), activation='relu', name='L7_conv2d', dtype="mixed_float16"),
  tf.keras.layers.Conv2D(512, (2, 2), activation='relu', name='L8_conv2d', dtype="mixed_float16"),
